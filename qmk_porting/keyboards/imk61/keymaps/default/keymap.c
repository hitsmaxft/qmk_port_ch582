...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_all(/* 0: qwerty */
                     ...
                     KC_LCTL, KC_LGUI, KC_LALT, KC_SPC, KC_SPC, KC_SPC,  KC_RALT,KC_RCTL, KC_MENU, MO(1)),
    [1] = LAYOUT_all(/* 1: fn */
                     ...
                     _______, RGB_TOG, RGB_MOD, RGB_HUI,_______, _______, _______, RGB_VAI, RGB_VAD,  KC_VOLD, KC_VOLU, KC_MUTE, 
